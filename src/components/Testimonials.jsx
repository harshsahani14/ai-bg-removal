...
const Testimonials = () => {
  return (
    <div>
        ...
        <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-bold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent mb-12 sm:mb-20 '> Customer Testimonials</h1>
